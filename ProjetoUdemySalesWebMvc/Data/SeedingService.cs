...
using ProjetoUdemySalesWebMvc.Models.Enums;
using System;
using System.Linq;
...
namespace ProjetoUdemySalesWebMvc.Data
{
    ...
    {
        private ProjetoUdemySalesWebMvcContext _context;

        public SeedingService(ProjetoUdemySalesWebMvcContext context)
        {
            _context = context;
        }

        //A operação Seed se chama dentro do Startup e dentro no método Configure
        public void Seed()
        {
            //Any serve para retornar um bool caso tenha qualquer dado dentro dela, nesse caso retorna true caso tenha qualquer linha populada 
            //em alguma dessas tabelas
            ...
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 20), 3000.0, d4);
            ...
            //AddRange serve para adicionar vários objetos de uma só vez
            ...
            //salva e confirma as alterações no bd
